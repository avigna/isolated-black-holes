function [  sys_realMassZAMS, ...
            ...
            isolated_mass_SN,...
            isolated_stellar_type_SN] = referee_resampling_COMPAS(filename,debugFlag,lowerLimit)
...
sys_semi_major_axis     = h5read(filename,'/BSE_System_Parameters/SemiMajorAxis@ZAMS');
