...
% Mroz: https://ui.adsabs.harvard.edu/abs/2022ApJ...937L..24M/abstract
mass_Mroz = 7.88;
error_Mroz = 0.82;
velocity_Mroz = 40.1;
...
% The following were calculated to compare merging vs non-merging DCOs.
% The mass vs CoM parameter space they lead to turns out to be quite
% similar.
% 13. NS-BH, BH-NS
index_all_BHNSs = find( ((SNe_stellar_type_SN == NEUTRON_STAR & SNe_stellar_type_CP == BLACK_HOLE) |...
                        (SNe_stellar_type_SN == BLACK_HOLE & SNe_stellar_type_CP == NEUTRON_STAR))...
